...
for t_d in training_dataset:
    ...
    for f_model in from_model:
        ...
        root_dir1 = "proj_prompt_roberta_to_t5xxl/"+t_d+"/"+f_model+"/prompts/"
        root_dir2 = "task_prompt_emb/"

        #root_dir1_act = "task_activated_neuron/cross_model_xxlt5_neuron/from_"+f_model+"/"
        root_dir1_act = "proj_prompt_roberta_to_t5xxl/"+t_d+"/"+f_model+"/neurons/"
        ...
        for prompt in root_prompts:
            ...
            task_ten_1 = torch.load(root_dir1+prompt+"/latest.pt", map_location=lambda storage, loc: storage)
