...
#restaurant
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/restaurantPromptRoberta.config \
    --gpu $gpus \
...
#IMDB
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/IMDBPromptRoberta.config \
    --gpu $gpus \
    --checkpoint model/IMDBPromptRoberta/15.pkl \


#SST-2
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/SST2PromptRoberta.config \
    --gpu $gpus \
...
#MRPC
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/MRPCPromptRoberta.config \
    --gpu $gpus \
    --checkpoint model/MRPCPromptRoberta/15.pkl \

#QQP
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/QQPPromptRoberta.config \
    --gpu $gpus \
...
#WNLI
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/WNLIPromptRoberta.config \
    --gpu $gpus \
...
#IMDB
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/IMDBPromptBert.config \
    --gpu $gpus \
    --checkpoint model/IMDBPromptBert/15.pkl \


#SST-2
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/SST2PromptBert.config \
    --gpu $gpus \
...
#MRPC
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/MRPCPromptBert.config \
    --gpu $gpus \
    --checkpoint model/MRPCPromptBert/15.pkl \

#QQP
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/QQPPromptBert.config \
    --gpu $gpus \
...
#RTE
#Remove prompts between two sentences
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/RTEPromptBert.config \
    --gpu $gpus \
    --checkpoint model/RTEPromptBert/15.pkl \

#MNLI
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/MNLIPromptBert.config \
    --gpu $gpus \
...
#WNLI
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/WNLIPromptBert.config \
    --gpu $gpus \
...
#QNLI
CUDA_VISIBLE_DEVICES=$gpus python3 valid_projector_prompt.py --config config/QNLIPromptBert.config \
    --gpu $gpus \
