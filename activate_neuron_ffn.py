...
if __name__ == "__main__":
    ...
    #merge 17 epoch
    for k in range(12):
        #outputs_dense[k] = torch.relu(torch.cat(outputs_dense[k]))
        #print(outputs_intermediate[k][0][0].shape)
        #print(outputs_dense[k][0][0].shape)
        #torch.Size([1, 231, 3072])
        #torch.Size([1, 231, 768])
        output = torch.cat((outputs_intermediate[k][0],outputs_dense[k][0]),2)
        #output = torch.cat(output)
        #print(output)
        #exit()
        #outputs[k] = torch.relu(torch.cat(output))
        outputs[k] = torch.relu(output)
        #exit(outputs[k].shape)
        #exit()

        #print(outputs_intermediate[k])
        #outputs_intermediate[k] = torch.relu(torch.cat(outputs_intermediate[k]))
        #print(outputs_intermediate[k].shape)
        #exit()
        #print(outputs_dense[k].shape)
        #exit()
        #print(outputs_intermediate)
        #print(outputs_dense)
        #exit()
