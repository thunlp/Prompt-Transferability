...
class mutiGPU_STSBPromptRobertaFormatter(BasicFormatter):
    ...
    def process(self, data, config, mode, *args, **params):
        ...
        ret = {
            ...
            "label": torch.tensor(label, dtype=torch.float) if config.get("data", "train_dataset_type") == "STSB" else torch.tensor(label, dtype=torch.long)
        }
        return ret
