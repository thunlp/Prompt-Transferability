...
from tools.init_tool_projector_prompt import init_all
from config_parser import create_config
from tools.valid_tool_projector_prompt import valid
...
if __name__ == "__main__":
    ...
    if config.get("model","model_name") != "projectPromptRoberta_prompt":
