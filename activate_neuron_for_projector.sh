...
#for MODEL in IMDBPromptRoberta_proj laptopPromptRoberta_proj restaurantPromptRoberta_proj MNLIPromptRoberta_proj QNLIPromptRoberta_proj snliPromptRoberta_proj
...
#for MODEL in IMDB_trainedPromptRoberta
do
    echo "==========================="
