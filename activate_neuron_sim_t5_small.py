...
data_name = [dir.replace("PromptT5Small","").replace("_label","").replace("urant","").replace("evalsentiment","").replace("rationales","") for dir in dirs]
...
for dir_1 in dirs:
    ...
    print_name = dir_1.replace("PromptT5Small","").replace("recast","").replace("ethics","")
    ...
    #exit()
    #####
    activated_1 = activated_1[:,0:1,:,:]
    #activated_1 = activated_1[9:12,1:2,:,:]
    #activated_1 = activated_1[start_layer:start_layer+3,0:1,:,:]
    #####
    ...
    for dir_2 in dirs:
        ...
        #####
        activated_2 = activated_2[:,0:1,:,:]
        #activated_2 = activated_2[9:12,1:2,:,:]
        #activated_2 = activated_2[start_layer:start_layer+3,0:1,:,:]
        #####
